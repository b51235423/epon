...
public:
    ...
    void insert(int LLID,cPacket *packet);
    cPacket* remove(int LLID,cPacket *packet);
    cPacket* pop(int LLID);
    cPacket* pop(int LLID,int priority);
    cPacket* popS2(int LLID);
    cPacket* popS2(int LLID,int priority);
    ...
    cPacket* front(int LLID);
    cPacket* s2front(int LLID);
    cPacket* s1front(int LLID);
    cPacket* s1front(int LLID,int priority);
    cPacket* back(int LLID);
    cPacket* s2back(int LLID);
